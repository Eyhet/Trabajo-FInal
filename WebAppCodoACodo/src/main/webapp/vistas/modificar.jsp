    ...
    <body>        
        <div class="container" >
		    ...
		    Usuarios resultado=null;
                    ...
                    resultado = u1.mostrarUsuarios(mid);				
		    %>
                    <form class="p-5" method="POST" action="UsuariosControl?accion=actualizar">
                         <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" id="contrasena" name="contrasena" value=<%=resultado.getContrasena()%> >                          
                        </div> 
